...
const KeysView = (options: RouteOptions) => applyMainLayout(options, htm`
  <Box marginTop="20px" display="flex" flexDirection="column" alignItems="center" textAlign="center">
    <P>
      ...
      <BR/>
      <BR/>
      To connect your Pusher Channels App, visit your app's page from your <Link href="https://dashboard.pusher.com" target="_blank">Channels dashboard</Link>, select the <B>App Keys</B> page and paste the credentials below:
    </P>
    <BR/>
    <BR/>
    <Textarea
