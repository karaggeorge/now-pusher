  ...
  return htm`
    ...
    <Fieldset>
      <FsContent>
        ...
        <P>Add the Pusher Channels server SDK to your project</P>
        ...
        <BR/>
        <P>The <Link href="https://pusher.com/docs/channels/server_api/overview" target="_blank">docs</Link> contain more information on how to use the SDK</P>
      </FsContent>
      <FsFooter>
    ...
    <Fieldset>
      <FsContent>
        ...
        <P>Add the Pusher Channels client SDK to your project</P>
        ...
        <BR/>
        <P>The <Link href="https://pusher.com/docs/channels/getting_started/javascript" target="_blank">docs</Link> contain more information on how to use the SDK</P>
      </FsContent>
    </Fieldset>
  `;
};
